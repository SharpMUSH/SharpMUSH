	...
	public static IEnumerable<object[]> SubstringLengthData
	{
		get
		{
			return [
				...
				[A.concat(A.markupSingle( M.Create(foreground: StringExtensions.rgb(Color.Red)),"red"),A.markupSingle(M.Create(foreground: StringExtensions.rgb(Color.Blue)), "cat")),
					4, A.concat(A.markupSingle(M.Create(foreground: StringExtensions.rgb(Color.Red)),"red"),A.markupSingle(M.Create(foreground: StringExtensions.rgb(Color.Blue)), "c"))],
				[A.multiple([A.markupSingle2(M.Create(foreground: StringExtensions.rgb(Color.Red)), A.single("red")),
						...
						A.markupSingle2(M.Create(foreground: StringExtensions.rgb(Color.Blue)), A.single("cat"))]),
					7, A.multiple([A.markupSingle2(M.Create(foreground: StringExtensions.rgb(Color.Red)), A.single("red")),
						A.markupSingle2(M.Create(foreground: StringExtensions.rgb(Color.Blue)), A.single("cat")),
	...
	public static IEnumerable<object[]> SubstringData
	{
		get
		{
			return [
				...
				[A.concat(A.markupSingle( M.Create(foreground: StringExtensions.rgb(Color.Red)),"red"),A.markupSingle(M.Create(foreground: StringExtensions.rgb(Color.Blue)), "cat")),
					2, A.concat(A.markupSingle(M.Create(foreground: StringExtensions.rgb(Color.Red)),"d"),A.markupSingle(M.Create(foreground: StringExtensions.rgb(Color.Blue)), "cat"))],
				[A.multiple([A.markupSingle2(M.Create(foreground: StringExtensions.rgb(Color.Red)), A.single("red")),
						A.markupSingle2(M.Create(foreground: StringExtensions.rgb(Color.Blue)), A.single("cat")),
						A.markupSingle2(M.Create(foreground: StringExtensions.rgb(Color.Green)), A.single("green")),
						A.markupSingle2(M.Create(foreground: StringExtensions.rgb(Color.Blue)), A.single("cat"))]),
					8, A.multiple([A.markupSingle2(M.Create(foreground: StringExtensions.rgb(Color.Green)), A.single("een")),
						A.markupSingle2(M.Create(foreground: StringExtensions.rgb(Color.Blue)), A.single("cat"))])],
				[A.concat(A.markupSingle( M.Create(foreground: StringExtensions.rgb(Color.Red)),"red"),A.markupSingle(M.Create(foreground: StringExtensions.rgb(Color.Blue)), "cat")),
