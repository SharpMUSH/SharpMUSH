...
/// <summary>
/// WebAppFactory configured for function tests with isolated database
/// </summary>
public class FunctionTestWebAppFactory : WebAppFactory
{
	private const string DatabaseName = "sharpmush_test_functions";

	public FunctionTestWebAppFactory() : base(null, DatabaseName, "mysql")
	{
	}
