...
public class UtilityFunctionUnitTests
{
	...
	[Arguments("[setq(alpha,1,beta,2)][registers(*,qregisters,|)]", "ALPHA|BETA")]
	[Arguments("[setq(alpha,1,beta,2)][registers(,bogus)]", ErrorMessages.Returns.InvalidArgument)]
	[Arguments("[setq(alpha,1,beta,2)][registers(,q)]", ErrorMessages.Returns.InvalidArgument)]
	[Arguments("[setq(alpha,1,beta,2)][registers(,QREGISTERS)]", "ALPHA BETA")]
