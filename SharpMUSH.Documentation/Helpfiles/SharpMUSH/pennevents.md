...
For a list of events and their arguments, see [help event list|event list].

For some examples of using events, see [help event examples|event examples].
...
For more examples, see [help event examples2|event examples2].
...
The following event types and events have been added to SharpMUSH. To see the help for them, type [help event <type>|event]:
