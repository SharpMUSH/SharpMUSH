...
public sealed class SharpMUSHCommandLibraryGenerator : IIncrementalGenerator
{
		...
		(Compilation Left, ImmutableArray<(MethodDeclarationSyntax Method, AttributeData Attribute)> list) tuple)
	{
		...
		var factories = infoList.Where(info => !info.StaticMethod)
			...
			.Select(group => $$"""
			                   /// <summary>The commands the given instance implements, each bound to that instance.</summary>
			                   public static Dictionary<string, SharpMUSH.Library.Definitions.CommandDefinition> Create({{group.Key}} instance) => new Dictionary<string, SharpMUSH.Library.Definitions.CommandDefinition>
			                   {
		...
		var code = $$"""
		             ...
		             public static class CommandLibrary 
		             {
		               ...
		               /// <summary>The commands declared as static methods in this assembly.</summary>
	...
	private static string InfoToSource(CommandInformation info, string receiver)
	{
		return
			$$"""
			  { 
