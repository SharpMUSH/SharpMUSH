...
public class LinkRoomCommandHandler(IObjectStore database) : ICommandHandler<LinkRoomCommand, bool>
{
...
public class UnlinkRoomCommandHandler(IObjectStore database) : ICommandHandler<UnlinkRoomCommand, bool>
{
