...
public static partial class Commands
{
	...
	public static async ValueTask<Option<CallState>> Channel(IMUSHCodeParser parser, SharpCommandAttribute _2)
	{
		...
		return switches switch
		{
			...
			["ON"] or ["JOIN"] => await ChannelOn.Handle(parser, args["0"].Message!, args["1"].Message, switches),
			["OFF"] or ["LEAVE"] => await ChannelOff.Handle(parser, args["0"].Message!, args["1"].Message, switches),
