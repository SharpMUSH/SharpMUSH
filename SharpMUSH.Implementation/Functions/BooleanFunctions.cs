...
public static partial class Functions
{
	...
	public static ValueTask<CallState> And(IMUSHCodeParser parser, SharpFunctionAttribute _2)
		=> ValueTask.FromResult<CallState>(new(parser.CurrentState.Arguments.Select(x => x.Value.Message!).All(Predicates.Truthy) 
			? "1" 
			: "0"));
	...
	public static ValueTask<CallState> Eq(IMUSHCodeParser parser, SharpFunctionAttribute _2)
		=> ValueTask.FromResult<CallState>(new(parser.CurrentState.Arguments.All(x => x.Value.Message == parser.CurrentState.Arguments["0"].Message) 
			? "0" 
			: "1"));
	...
	public static ValueTask<CallState> Nand(IMUSHCodeParser parser, SharpFunctionAttribute _2)
		=> ValueTask.FromResult<CallState>(new(parser.CurrentState.Arguments.Select(x => x.Value.Message!).Any(Predicates.Falsey) ? "1" : "0"));
	...
	public static ValueTask<CallState> CNand(IMUSHCodeParser parser, SharpFunctionAttribute _2)
		=> ValueTask.FromResult<CallState>(new(parser.CurrentState.Arguments.Select(x => x.Value.Message!).Any(m => Predicates.Falsey(parser.FunctionParse(m).AsTask().Result!.Message!)) ? "0" : "1"));
	...
	public static ValueTask<CallState> Neq(IMUSHCodeParser parser, SharpFunctionAttribute _2)
		=> ValueTask.FromResult<CallState>(new(parser.CurrentState.Arguments.Any(x => x.Value.Message == parser.CurrentState.Arguments["0"].Message) ? "0" : "1"));
	...
	public static ValueTask<CallState> Nor(IMUSHCodeParser parser, SharpFunctionAttribute _2)
		=> ValueTask.FromResult<CallState>(new(parser.CurrentState.Arguments.Select(x => x.Value.Message!).All(Predicates.Falsey) ? "1" : "0"));
	...
	public static ValueTask<CallState> NCor(IMUSHCodeParser parser, SharpFunctionAttribute _2)
		=> ValueTask.FromResult<CallState>(new(parser.CurrentState.Arguments.Select(x => x.Value.Message!).All(m => Predicates.Falsey(parser.FunctionParse(m).AsTask().Result!.Message!)) ? "1" : "0"));
	...
	public static ValueTask<CallState> Not(IMUSHCodeParser parser, SharpFunctionAttribute _2)
		=> ValueTask.FromResult<CallState>(new(Predicates.Falsey(parser.CurrentState.Arguments.First().Value.Message!) ? "1" : "0"));
	...
	public static ValueTask<CallState> Or(IMUSHCodeParser parser, SharpFunctionAttribute _2)
		=> ValueTask.FromResult<CallState>(new(parser.CurrentState.Arguments.Select(x => x.Value.Message!).Any(Predicates.Truthy) ? "1" : "0"));
	...
	public static ValueTask<CallState> T(IMUSHCodeParser parser, SharpFunctionAttribute _2)
		=> ValueTask.FromResult<CallState>(new(Predicates.Truthy(parser.CurrentState.Arguments.FirstOrDefault().Value.Message!) ? "1" : "0"));
	...
	public static ValueTask<CallState> Xor(IMUSHCodeParser parser, SharpFunctionAttribute _2)
		=> ValueTask.FromResult<CallState>(new(parser.CurrentState.Arguments.Select(x => x.Value.Message!).Where(Predicates.Truthy).Count() == 1 ? "1" : "0"));
}