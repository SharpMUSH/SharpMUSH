	...
	: SharpMUSHParserBaseVisitor<ValueTask<CallState?>>
{
	...
	public async ValueTask<CallState> CallFunction(ILogger logger, string name, MString source,
		...
		DiscoverBuiltInFunction(string name)
	{
		...
		return (result.LibraryInformation.Attribute, new Func<IMUSHCodeParser, ValueTask<CallState>>
