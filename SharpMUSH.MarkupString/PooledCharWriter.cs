...
/// <summary>
/// A growable <see cref="IBufferWriter{T}"/> over an <see cref="ArrayPool{T}"/> buffer. Used for
/// the scratch buffers the renderer nests emitters through; the buffer returns to the pool on
/// <see cref="Dispose"/>.
/// </summary>
