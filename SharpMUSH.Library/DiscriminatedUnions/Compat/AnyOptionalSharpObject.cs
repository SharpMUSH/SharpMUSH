...
partial class AnyOptionalSharpObject
{
	...
	public TResult Match<TResult>(Func<SharpPlayer, TResult> f0, Func<SharpRoom, TResult> f1, Func<SharpExit, TResult> f2, Func<SharpThing, TResult> f3, Func<None, TResult> f4) => Value switch
	{
	...
	public void Switch(Action<SharpPlayer> f0, Action<SharpRoom> f1, Action<SharpExit> f2, Action<SharpThing> f3, Action<None> f4)
	{
		switch (Value)
		{
			case SharpPlayer t0:
	...
	public static AnyOptionalSharpObject FromT0(SharpPlayer value) => new(value);
	public static AnyOptionalSharpObject FromT1(SharpRoom value) => new(value);
	public static AnyOptionalSharpObject FromT2(SharpExit value) => new(value);
	public static AnyOptionalSharpObject FromT3(SharpThing value) => new(value);
	public static AnyOptionalSharpObject FromT4(None value) => new(value);
}
