...
partial union OptionalObjectAttributeSplit
{
	...
	public static OptionalObjectAttributeSplit FromT0((string? db, string Attribute) value) => new(value);
	public static OptionalObjectAttributeSplit FromT1(bool value) => new(value);
}
