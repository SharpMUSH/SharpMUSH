...
public interface ILightningStorageAccessor
{
	...
	/// <summary>Enqueues <paramref name="job"/> to run on the dedicated writer thread, inside one committed write transaction.</summary>
	...
	/// Safe to call more than once for the same name; the existing definition is returned.
	/// </summary>
